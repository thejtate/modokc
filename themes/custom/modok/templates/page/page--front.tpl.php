...
<div class="outer-wrapper">
  ...
  <div id="header">
    <div class="site-header">
      ...
      <?php if ($logo): ?>
        <div class="logo">
          <a href="#"><img src="<?php print $logo; ?>" alt=""></a>
        </div>
      <?php endif; ?>
      ...
      <div class="social">
        ...
        <ul>
          <li class="soc-1"><?php print $facebook_link; ?></li>
          <li class="soc-2"><?php print $twitter_link; ?></li>
        </ul>
      </div>
      <nav class="nav">
  ...
  <footer id="site-footer" class="site-footer">
    <div class="logo">
      <a href="#">
        <img
          src="<?php print $theme_path; ?>/images/logo-s.png"
          alt="logo">
      </a>
    </div>
    ...
    <ul class="social">
      <li class="soc-1"><?php print $facebook_link; ?>
      </li>
      <li class="soc-2"><?php print $twitter_link; ?></li>
    </ul>
  </footer>
